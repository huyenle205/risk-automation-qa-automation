...
Feature: Chargeback SKIP Auto Hold Fund E2E
    ...
    @dev @live
    @automated
    Scenario: lost_reason is updated to one the actions ["DEDUCT_FROM_MERCHANT","COVERED_BY_XENDIT","DEDUCT_FROM_MERCHANT_PARTIAL"]
        Given The "Create chargeback action" request was created with action is one of next "MERCHANT_YEILD" action
        When the request is processed
        Then the response status should be "200 - OK"
        And The "deduction_status" should be "DEDUCTED" or "PARTIAL_DEDUCTED"
